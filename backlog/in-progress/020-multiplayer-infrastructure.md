...
- [x] Код написан и работает (020a-websocket-server, 020b-gamescene-integration)
...
- 020b: Клиентский менеджер + RemotePlayer + интеграция в GameScene ✓

**Осталось:**
- 020c: Тестирование, отладка, оптимизация сети
